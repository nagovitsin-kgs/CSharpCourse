...
/* double f(double x)  в начале double(ТИП), в скобках double это возвращаемый ТИП, аргумент x, который принимаем.
...
//Method21(count: 4, msg: "Новый текст");             // либо так. Задаём конкретно...
...
string Method4(int count, string text)
{
    ...
    {
        result = result + text;     // "склеивание" текста ZZZZZZ....
